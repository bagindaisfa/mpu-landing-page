...
const BreadCrumb = ({
  ...
  return (
    <div className="relative z-10 before:-z-10 before:absolute before:top-0 before:left-0 before:w-full before:h-[80%] before:bg-BodyBg4-0">
      <div className="bg-[url('/images/blogHeader.jpg')] bg-no-repeat bg-cover bg-center flex items-center justify-start h-[400px] sm:h-[500px] text-center mx-3 md:mx-10 lg:mx-[66px] rounded-2xl md:rounded-[30px]">

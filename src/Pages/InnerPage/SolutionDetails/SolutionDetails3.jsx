...
import serviceDetailsThumb from '/images/service_thumb03.png';
...
const SolutionDetails3 = () => {
  return (
    <>
      <BreadCrumb
        breadCrumbTitle={'Driving Efficiency and Workforce Agility'}
        breadCrumbIcon={<FaArrowRightLong />}
        breadCrumbIcon2={<FaArrowRightLong />}
        breadCrumbLink={'Solution Approach'}
        breadCrumbLink2={'Driving Efficiency and Workforce Agility'}
      />
      <Feature />
          ...
          <div className="grid grid-cols-3 mt-[62px]">
            <div className="col-span-3 lg:col-span-2 lg:mr-7 2xl:mr-[84px]">
              <h2 className="font-FiraSans font-semibold text-2xl sm:text-[42px] text-HeadingColor-0">
                Driving Efficiency and Workforce Agility
              </h2>
...
export default SolutionDetails3;

...
import serviceDetailsThumb from '/images/service_thumb01.png';
...
const SolutionDetails1 = () => {
  return (
    <>
      <BreadCrumb
        breadCrumbTitle={'Custom Leadership Development Framework'}
        breadCrumbIcon={<FaArrowRightLong />}
        breadCrumbIcon2={<FaArrowRightLong />}
        breadCrumbLink={'Solution Approach'}
        breadCrumbLink2={'Custom Leadership Development Framework'}
      />
      <Feature />

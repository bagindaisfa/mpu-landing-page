...
import serviceDetailsThumb from '/images/service_thumb02.png';
...
const SolutionDetails2 = () => {
  return (
    <>
      <BreadCrumb
        breadCrumbTitle={'Building a Future-Ready Leadership Benc'}
        breadCrumbIcon={<FaArrowRightLong />}
        breadCrumbIcon2={<FaArrowRightLong />}
        breadCrumbLink={'Solutin Approach'}
        breadCrumbLink2={'Building a Future-Ready Leadership Benc'}
      />
      <Feature />
          ...
          <div className="grid grid-cols-3 mt-[62px]">
            <div className="col-span-3 lg:col-span-2 lg:mr-7 2xl:mr-[84px]">
              <h2 className="font-FiraSans font-semibold text-2xl sm:text-[42px] text-HeadingColor-0">
                Building a Future-Ready Leadership Benc
              </h2>
...
export default SolutionDetails2;

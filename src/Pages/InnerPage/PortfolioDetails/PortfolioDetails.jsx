          ...
          <div className="pt-6 md:pt-[66px] px-4 md:px-[52px] relative z-10 sm:-mt-[60px] bg-white rounded-3xl md:mx-10 lg:mx-0 xl:mx-14 2xl:mx-0">
            <div className="lg:mr-7 2xl:mr-[84px]">
              ...
              <p className="font-FiraSans text-TextColor2-0 mt-[26px]">
                ...
                innovation with wireless vertical intellectual capital before
                global architectures technically sound engage based results with
                visionary models. Dramatically harness-platform best practices
                whereas business services. Conveniently experiences. formula
                standards in innovation with wireless
              </p>
